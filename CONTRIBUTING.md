...
4. For a new skill, keep SKILL.md concise, add accurate trigger metadata, generate agents/openai.yaml, and run the repository validation and unit-test commands in the README.
